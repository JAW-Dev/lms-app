...
const UserAgreementContent = () => (
  <>
    ...
    <div className="flex" style={{gap: '10px'}}>
      <Button href="/v2/program/subscriptions/new" variant="default-lowewrcase" className="font-bold capitalize" style={{ borderRadius: '12px' }}>Subscribe</Button>
...
const options = {
  ...
  innerStyle: { width: '100%', maxWidth: '1400' }
};

const SubscriptionNew = () => <Main options={options} />;
