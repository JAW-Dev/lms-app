...
const RightColumn = ({isTablet}) => {
  ...
  return (
    <div className="md:mt-12 mb-8 md:mb-0" style={{color: '#3C3C3C'}}>
      <BasicCard>
        <h6 className="mb-6 font-bold" style={{fontSize: '20px'}}>Sign up today</h6>
        <form className="h-full user-profile-form" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col">
            <label className="text-sm text-charcoal font-bold pb-2">What inspired you to sign up?</label>
...
const LeftColumn = () => {
  ...
  return (
    <>
      ...
      <h1 style={{ fontSize: '36px', lineHeight: '1.4', maxWidth: '25ch' }} className="text-charcoal font-black mb-8">
        Begin your journey to becoming a better leader
      </h1>
      <p className='mb-2'>By purchasing the complete Admired Leadership® course, you'll receive one year of full access to:</p>
      <ul className="pb-8" style={{paddingLeft: '1.5rem'}}>
        <li className='mb-1'>15+ hours of video and audio content.</li>
        <li className='mb-1'>100 behaviors, each explained in about 10 minutes or less.</li>
        <li className='mb-1'>10 distinct modules covering a wide variety of important leadership topics.</li>
        <li>Extensive study materials including behavior maps, questions, examples and exercises.</li>
      </ul>
      <p className='mb-2'>In addition to the content, subscribers will receive access to the following:</p>
      <ul className="pb-8" style={{paddingLeft: '1.5rem'}}>
        <li className='mb-1'>Invitation to the annual Admired Leadership Community Conference.</li>
        <li className='mb-1'>Weekly book summaries to stay abreast of the current writings on leadership.</li>
        <li className='mb-1'>Private webinars with an executive coach to have your questions answered live.</li>
        <li className='mb-1'>Monthly community discussion groups where leaders like yourself meet to discuss the Admired Leadership behaviors. </li>
        <li>An Admired Leadership coach will be on hand to facilitate the dialogue.</li>
      </ul>
      <p><span className="font-bold">Sign up now and get the complete course for just $1,000.</span>The full access is valid for 1-year from date of purchase. Renewal is $200 a year and does not automatically renew.</p>
    </>
  )
}
...
const AccesMe = () => <Main options={options} />;

export default AccesMe;